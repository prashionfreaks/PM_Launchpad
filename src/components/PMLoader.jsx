      ...
      <div className="pml-sky">
        ...
        <div className="pml-plane-wrap">
          <svg viewBox="0 0 64 64" width="52" height="52" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* Fuselage */}
            <path d="M8,30 Q20,24 44,28 Q52,29 56,32 Q52,35 44,36 Q20,40 8,34 Z"
              fill="url(#pml-pg)" />
            {/* Nose cone */}
            <path d="M44,28 Q58,30 62,32 Q58,34 44,36 Z"
              fill="#c7d2fe" />
            {/* Main wing (top) */}
            <path d="M24,28 Q30,14 40,16 Q36,24 34,28 Z"
              fill="url(#pml-wg)" opacity="0.95" />
            {/* Main wing (bottom) */}
            <path d="M24,36 Q30,50 40,48 Q36,40 34,36 Z"
              fill="url(#pml-wg)" opacity="0.85" />
            {/* Tail fin (top) */}
            <path d="M10,29 Q12,20 18,22 Q16,26 14,29 Z"
              fill="#818cf8" />
            {/* Tail fin (bottom) */}
            <path d="M10,35 Q12,44 18,42 Q16,38 14,35 Z"
            ...
            {/* Engine under wing */}
            <rect x="27" y="36" width="10" height="4" rx="2"
          ...
          <div className="pml-exhaust">
            <span style={{ '--ed': '0s',   '--ew': '18px' }} />
            <span style={{ '--ed': '0.1s', '--ew': '12px' }} />
            <span style={{ '--ed': '0.2s', '--ew': '8px'  }} />
          </div>
        </div>
      </div>
